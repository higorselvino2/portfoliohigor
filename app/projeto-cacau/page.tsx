      ...
      <main className="w-full mx-auto flex flex-col pb-20 pt-28 md:pt-40">
        ...
        <section className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-16 md:py-24 border-t border-white/5 mt-8 md:mt-12">
            <div className="bg-gradient-to-br from-[#eb5612]/20 to-brand-dark border border-[#eb5612]/30 rounded-[24px] sm:rounded-[40px] p-6 sm:p-12 lg:p-16 flex flex-col lg:flex-row gap-8 sm:gap-12 items-center relative overflow-hidden shadow-[0_0_50px_rgba(235,86,18,0.1)]">
                ...
                <div className="w-full lg:w-1/2 flex flex-col sm:flex-row gap-4 sm:gap-6 relative z-10" data-aos="fade-left">
                    <div className="w-full sm:w-1/2 rounded-[16px] sm:rounded-[24px] overflow-hidden border border-white/10 cursor-view shadow-xl aspect-[3/4] sm:aspect-auto">
                        <img src="/eu com troféu.jpg" alt="Higor Selvino com Troféu Anhembi Awards" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                    </div>
                    <div className="w-full sm:w-1/2 rounded-[16px] sm:rounded-[24px] overflow-hidden border border-white/10 cursor-view shadow-xl aspect-[3/4] sm:aspect-auto">
                        <img src="/troféu.jpg" alt="Troféu Anhembi Awards" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                    </div>
                </div>
            </div>
        </section>
            ...
            <div className="lg:col-span-8 flex flex-col gap-8 sm:gap-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 items-stretch py-8 sm:py-12 border-y border-white/5" data-aos="fade-up">
                    <div className="bg-white/5 rounded-[16px] sm:rounded-[24px] p-6 sm:p-10 flex justify-center items-center border border-white/5 h-full">
                        <img src="/logo CACAU SHOW.png" alt="Logo Cacau Show" className="w-full max-w-[150px] sm:max-w-[220px] h-auto object-contain opacity-80" />
                    </div>
                    <div className="bg-[#eb5612]/10 rounded-[16px] sm:rounded-[24px] p-6 sm:p-10 flex justify-center items-center border border-[#eb5612]/20 h-full">
                        <img src="/logo principal CACAU PARQUE.png" alt="Logo Cacau Parque" className="w-full max-w-[180px] sm:max-w-[280px] h-auto object-contain drop-shadow-[0_0_20px_rgba(235,86,18,0.4)]" />
                    </div>
                </div>
            </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16 items-start">
                <div className="lg:col-span-5 flex flex-col gap-8" data-aos="fade-right">
                    ...
                    <div className="rounded-[16px] sm:rounded-[24px] overflow-hidden border border-white/10 shadow-2xl cursor-view mt-4">
                        <img src="/paleta de cores c.png" alt="Paleta de Cores" className="w-full h-auto" />
                    </div>
                </div>
                <div className="lg:col-span-7 grid grid-cols-1 gap-6 sm:gap-8" data-aos="fade-left">
                    <div className="rounded-[16px] sm:rounded-[24px] overflow-hidden border border-white/10 shadow-2xl cursor-view">
                        <img src="/hirarquia tipografica (1).png" alt="Hierarquia" className="w-full h-auto" />
                    </div>
                    <div className="rounded-[16px] sm:rounded-[24px] overflow-hidden border border-white/10 shadow-2xl cursor-view">
                        <img src="/hirarquia tipografica (2).png" alt="Hierarquia" className="w-full h-auto" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-24 border-t border-white/5 bg-brand-card/30 rounded-[24px] sm:rounded-[40px] mt-8 sm:mt-12 mb-8 sm:mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-12">
                {[
                  { img: '/brinquedo MONTANHA-RUSSA GIRA CHOCOMONSTROS.png', label: 'Gira Chocomonstros' },
                  { img: '/brinquedo RODA GIGABYTES.png', label: 'Roda Gigabytes' },
                  { img: '/brinquedo BENDITO KAMIKAZE.png', label: 'Bendito Kamikaze' },
                  { img: '/brinquedo CHOCOBICHOS CARROSSEL.png', label: 'Chocobichos Carrossel' },
                  { img: '/brinquedo ESPAÇO MIAU KIDS.png', label: 'Espaço Miau Kids' },
                  { img: '/brinquedo EXPRESSO CHOCOLATE.png', label: 'Expresso Chocolate' },
                  { img: '/brinquedo JARDIM DA BELLA.png', label: 'Jardim da Bella' },
                  { img: '/brinquedo MONTANHA RUSSA MONTEBELLO.png', label: 'Montanha Russa Montebello' }
                ].map((item, i) => (
                    <div key={i} className="flex flex-col items-center gap-3 sm:gap-4 group" data-aos="zoom-in" data-aos-delay={(i % 4) * 100}>
                        <div className="w-full aspect-square rounded-full bg-white/5 border border-white/10 flex items-center justify-center p-6 sm:p-10 transition-all group-hover:bg-[#eb5612]/20 cursor-view shadow-xl">
        ...
        <section className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-24 border-t border-white/5">
            ...
            <div className="w-full aspect-[16/9] sm:aspect-video rounded-[16px] sm:rounded-[24px] overflow-hidden bg-brand-card shadow-2xl border border-white/10 mb-12 sm:mb-16" data-aos="fade-up">
                <video className="w-full h-full object-cover" controls playsInline poster="/ultrawide imagem cacau parque.jpg">
                    <source src="/YTDown.com_YouTube_Media_RrafOBqSf9o_001_1080p.mp4" type="video/mp4" />
                </video>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 mb-12 sm:mb-16">
                {[1,2,3,4,5].map((num) => (
                    <div key={num} className="rounded-xl sm:rounded-2xl overflow-hidden cursor-view border border-white/5 bg-brand-card" data-aos="fade-up" data-aos-delay={num * 100}>
                        <img src={`/embalagem ${num}.png`} className="hover:scale-110 transition-all duration-500 w-full h-auto" />
                    </div>
                ))}
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
                <div className="rounded-[16px] sm:rounded-[24px] overflow-hidden border border-white/10 shadow-2xl cursor-view bg-brand-card" data-aos="fade-right"><img src="/embalagem na gondula mockup.png" className="w-full h-auto hover:scale-105 transition-transform duration-1000" /></div>
                <div className="rounded-[16px] sm:rounded-[24px] overflow-hidden border border-white/10 shadow-2xl cursor-view bg-brand-card" data-aos="fade-left"><img src="/poster mockup sem fundo.png" className="w-full h-auto hover:scale-105 transition-transform duration-1000" /></div>
            </div>
        </section>
        ...
        <section className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-24 border-t border-white/5 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-center">
                <div className="relative flex justify-center items-center cursor-view" data-aos="zoom-in">
                    <img src="/bilhete dourado.png" className="w-full max-w-[350px] sm:max-w-[450px] rounded-2xl shadow-2xl drop-shadow-[0_0_40px_rgba(235,86,18,0.3)] hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="flex flex-col gap-6 sm:gap-8" data-aos="fade-left">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <div className="rounded-2xl overflow-hidden border border-white/10 cursor-view shadow-xl bg-brand-card"><img src="/foto bilhete saindo da embalagem.png" className="w-full h-auto hover:scale-105 transition-transform" /></div>
                        <div className="rounded-2xl overflow-hidden border border-white/10 cursor-view shadow-xl bg-brand-card"><img src="/varios bilhetes dourados foto.png" className="w-full h-auto hover:scale-105 transition-transform" /></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12 sm:py-24 border-t border-white/5">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-center">
                <div id="map-container" className="lg:col-span-7 rounded-[16px] sm:rounded-[24px] lg:rounded-[40px] overflow-hidden border border-white/5 shadow-2xl shadow-[0_0_50px_rgba(235,86,18,0.1)] relative cursor-crosshair" data-aos="fade-right">
                    <img id="map-image" src="/mapa projetado do cacau parque.png" className="w-full h-auto transition-transform duration-300 ease-out hover:scale-[2.5]" />
                </div>
